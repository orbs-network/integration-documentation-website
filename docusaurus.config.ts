...
const config: Config = {
  ...
  baseUrl: '/integration-documentation-website/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'orbs-network', // Usually your GitHub org/user name.
  projectName: 'integration-documentation-website', // Usually your repo name.
